...
class TrovaParolaDiagonale {
    ...
    boolean trovaParolaDiagonale(char[][] g, char[] p, int r, int c, boolean decrescente) {
        int i = 0;
        ...
        while (i < p.length && (trovabileDaDestra || trovabileDaSinistra)) {
            ...
            // Se decrescente==true incremento l'indice riga poiché mi sto spostando
            // nella direzione da Alto-Sinistra verso Basso-Destra.
            // Se decrescente==false decremento l'indice riga poiché mi sto spostando
            // nella direzione da Basso-Sinistra verso Alto-Destra.
            r = decrescente ? r + 1 : r - 1;
            c++;
            i++;
        }
